...
export default function InterviewScreen({ session, auth, onBack }) {
  const [phase, setPhase] = useState("loading"); // loading | answering | evaluating | result | done
  ...
  async function submitAnswer() {
    ...
    try {
      ...
      setError(ex.message);
      setPhase("answering"); // let them retry
    }
  }
      ...
      <div style={styles.centeredFill}>
        <div style={styles.spinnerWrap}>
          ...
          <p style={{ fontSize: "0.75rem", color: "#94a3b8", marginTop: 6 }}>
            Analysing CV gaps from this session
          </p>
        </div>
      </div>
    );
    ...
    return (
      <div style={{ flex: 1, overflowY: "auto", padding: "32px" }}>
        <div style={{ maxWidth: 760, margin: "0 auto" }}>
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 16, marginBottom: 32 }}>
            ...
            <div>
              ...
              <p style={{ color: "#64748b", fontSize: "0.85rem" }}>
                {allResults.length} question{allResults.length !== 1 ? "s" : ""} answered
              </p>
            </div>
            {overallScore !== null && (
          ...
          <button style={{ ...styles.primaryBtn, width: "100%", marginTop: 8 }} onClick={onBack}>
            ← Back to Analysis
          </button>
        </div>
      </div>
  ...
  return (
    <div style={{ flex: 1, display: "flex", flexDirection: "column", overflowY: "auto" }}>
      <div style={{ maxWidth: 800, margin: "0 auto", width: "100%", padding: "28px 32px", flex: 1 }}>
        ...
        {/* error inline */}
        {error && (
          <div style={{ ...styles.errBar, marginBottom: 16 }}>⚠ {error} — please try again.</div>
        )}
        ...
        {phase === "answering" && (
          <>
            ...
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginTop: 12 }}>
              ...
              <button
                style={{ ...styles.primaryBtn, opacity: answer.trim() ? 1 : 0.45 }}
        ...
        {phase === "result" && evaluation && (
          <div style={{ animation: "fadeUp 0.3s ease" }}>
            ...
            <details style={{ marginTop: 12 }}>
              <summary style={{ cursor: "pointer", fontSize: "0.78rem", color: "#64748b", marginBottom: 8 }}>
                Your answer
              </summary>
...
const styles = {
  ...
  interviewerLabel: {
    ...
    color: "#0ea5e9", textTransform: "uppercase", marginBottom: 10,
  },
  questionText: {
  ...
  answerTextarea: {
    width: "100%", minHeight: 80, maxHeight: 260,
    padding: "14px 16px",
    border: "1.5px solid #e2e8f0", borderRadius: 10,
    fontSize: "0.9rem", lineHeight: 1.6, color: "#1e293b",
